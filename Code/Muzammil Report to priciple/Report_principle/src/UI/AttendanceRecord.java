...
public class AttendanceRecord extends javax.swing.JFrame {
 ...
 DefaultTableModel dtm;
    private void populateDataFromDataBase(ArrayList<AttendanceRecordDTO> list){
        dtm  = AAS_Creator.getInstanceOF_DefaultTableModel();
        try{
            dtm.addColumn("!D");
            dtm.addColumn("First Name");
            dtm.addColumn("Last Name");
            dtm.addColumn("TotalClasses");
            dtm.addColumn("Absentees");
             dtm.addColumn("Presents");
        for (AttendanceRecordDTO std : list) {
                Object[] rowData = AAS_Creator.getInstanceOf_Object(6);
                rowData[0] = std.id;
                rowData[1] = std.Firstname;
                rowData[2] = std.Lastname;
                rowData[3] = std.classes;
               rowData[4] = std.Absent;
               rowData[5] = std.Present;
              dtm.addRow(rowData);
            }
        ...
        ArrayList<AttendanceRecordDTO> teacherList = objController.CheckAttendanceList(searchKeyword);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Report Record to Principle");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(teacher, javax.swing.GroupLayout.PREFERRED_SIZE, 717, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
